...
import net.dzikoysk.wildskript.expressions.ExprCalendar;
import net.dzikoysk.wildskript.expressions.ExprConnectResult;
import net.dzikoysk.wildskript.expressions.ExprIP;
import net.dzikoysk.wildskript.expressions.ExprNull;
import net.dzikoysk.wildskript.expressions.ExprPing;
import net.dzikoysk.wildskript.expressions.ExprRandomLetter;
import net.dzikoysk.wildskript.expressions.ExprRandomColor;
import net.dzikoysk.wildskript.expressions.ExprSlimeSize;
import net.dzikoysk.wildskript.expressions.ExprSlot;
import net.dzikoysk.wildskript.expressions.ExprWildSkript;
import net.dzikoysk.wildskript.expressions.bukkit.ExprAllowEnd;
import net.dzikoysk.wildskript.expressions.bukkit.ExprAllowNether;
import net.dzikoysk.wildskript.expressions.bukkit.ExprBukkitVersion;
import net.dzikoysk.wildskript.expressions.bukkit.ExprMaxPlayers;
import net.dzikoysk.wildskript.expressions.bukkit.ExprMotd;
import net.dzikoysk.wildskript.expressions.bukkit.ExprOnlineMode;
import net.dzikoysk.wildskript.expressions.bukkit.ExprServerIP;
import net.dzikoysk.wildskript.expressions.bukkit.ExprServerName;
import net.dzikoysk.wildskript.expressions.bukkit.ExprServerPort;
